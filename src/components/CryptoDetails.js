...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed top-0 z-20 w-full h-full bg-gray-200 bg-opacity-30 first-letter:
    backdrop-blur-sm flex items-center justify-center font-nunito
    "
      onClick={close}
    >
      <div
        className="xl:w-[65%] lg:w-[75%] md:w-[90%] sm:w-[75%] w-[90%]  lg:h-[87%] md:h[70%] h-[90vh] scrollbar-thin md:overflow-hidden scrollbar-thumb-gray-100 scrollbar-track-gray-200 overflow-hidden bg-gray-300 bg-opacity-75 rounded-lg text-white relative "
      ...
      >
        ...
        "
          ...
          `}
              ...
              <div className="flex w-full mt-4 justify-between sm:flex-rowf flex-col">
                <div className="flex flex-col">
                  <a
                    target={"_blank"}
                    rel="noreferrer"
          ...
          `}
            ...
            <div className="absolute md:bottom-8 bottom-4 right-4 flex items-center md:flex-row flex-col sm:right-8">
              ...
              {data.links.facebook_username && (
                <a
                  className="text-lg px-1 md:pt-0 pt-1"
                  target={"_blank"}
                  rel="noreferrer"
