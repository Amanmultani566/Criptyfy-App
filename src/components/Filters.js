    ...
    <div
      ...
      <div className="flex lg:mr-7 justify-between mt-4 lg:mt-0 sm:flex-row flex-col relative">
        ...
        >
          ...
          ">
            <span className="
            mr-2 sm:text-base text-sm sm:font-bold font-medium
            ">
              Currency:
            </span>
          </label>
     ...
     sm:text-base text-sm sm:p-0 sm:pl-2 pl-1
     "
          />
        ...
        <label className="relative flex sm:justify-center justify-start mt-0 sm:mt-0 items-center">
          <span className="mr-2 sm:font-bold font-medium sm:text-base text-sm w-16">Sort by: </span>
          <select
            name="sortby"
            className="rounded bg-gray-200 sm:text-base text-sm 
         pl-2 pr-10 py-1.5 leading-4 capitalize focus:outline-0 text-transparent appearance-none w-full sm:w-48
         "
            onClick={handleSort}
          >
            <option value="market_cap_desc" 
            className="sm:text-base text-sm"
            >market cap descending</option>
            <option value="market_cap_asc"
            className="sm:text-base text-sm"
            >market cap ascending</option>
            <option value="volume_desc"
            className="sm:text-base text-sm"
            >volume descending</option>
            <option value="volume_asc"
            className="sm:text-base text-sm"
            >volume ascending</option>
            ...
            className="sm:text-base text-sm"
            >id ascending</option>
            <option value="gecko_desc"
            className="sm:text-base text-sm"
            >gecko descending</option>
            <option value="gecko_asc"
            className="sm:text-base text-sm"
            >gecko ascending</option>
          </select>
          <img
            src={selectIcon}
            alt="submit"
        ...
        <button
          className="w-[2rem] ml-4 hover:scale-110 transition-all transition-ease absolute right-0
          top-0 sm:relative
        "
