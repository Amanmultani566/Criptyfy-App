  ...
  return (
    ...
    >
      ...
      <input
        ...
        ref={inputRef}
        placeholder="10"
        className="hover:appearance-none appearance-none w-8 h-6 rounded bg-gray-200 placeholder:text-gray-100 placeholder:text-sm required outline-0 border border-transparent focus:border-cyan leading-4 text-center text-sm
     "
      />
      ...
      <div className="flex items-center md:flex-row flex-col md:mt-0 mt-4">
        ...
        <ul className="flex items-center justify-end text-sm sm:mt-0 mt-4">
          ...
          <li>
            <button
              disabled
              className="ouline-0  rounded-full w-8 h-8 flex items-center justify-center bg-cyan text-lg "
            >
              {page}
            </button>
          </li>
